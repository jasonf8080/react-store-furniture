  ...
  return <Wrapper>
    <div className="content">
      <form onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="form-control">
          ...
          <div>
            {categories.map((item, index) => {
              return <button className={`${category === item.toLowerCase() ? 'active' : null }`} key={index}
              name='category'
        ...
        <div className="form-control">
          <h5>Company</h5>
          <select name="company" className='company' value={company} onChange={updateFilters}>{/* Current company state*/}
        ...
        <div className="form-control">
          ...
          <div className='colors'>
            {colors.map((item, index) => {
              ...
              return <button key={index} name='color' style={{background: item}}
